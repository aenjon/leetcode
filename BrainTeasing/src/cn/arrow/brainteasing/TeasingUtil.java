...
public class TeasingUtil {
    ...
    /*
     * public static void printListString(List<String> list){ if (list == null)
     * return; int i = 0; for (String s : list){ System.out.print(i++ + "-" + s
     * + ","); } System.out.println(); }
     */
    ...
    /*
     * public static void printListInteger(List<Integer> list){ if (list ==
     * null) return; for (Integer a : list){ System.out.print(a.intValue() +
     * ","); } System.out.println(); }
     */
     ...
     * @param range
     *            The range of the value of integer elements
